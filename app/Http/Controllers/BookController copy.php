...
class BookController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Book/Product', ['books' => $books]);
    ...
    public function maxdiscount()
    {
        ...
        $discount = [0, 0.05, 0.10, 0.20, 0.25];
        $bookPrice = 8;
        ...
        foreach ($arrays as $array) {
            ...
            $discount = $discount[$num_books - 1] * $bookPrice * $num_books;
            $subtotal = $bookPrice * $num_books;
